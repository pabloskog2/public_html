...
<?php include  'include/nav.php' ?>
	...
	<div class="col-md-6">
		...
		<table class="table table-bordered tablie">
			...
			<tr>
				<td>UF Desde</td>
				<td><?=d($vivienda['precio']);?></td>
			</tr>
						
			<tr>
				<td>$</td>
				<td id="uf_total"><?=number_format((str_replace(".","",$vivienda['precio']) * $valor_uf), 0, ',', '.');?></td>
			</tr>
			</tbody>					
		</table>
	</div>
			...
			<table class="table table-bordered tablie">
				<tbody>
					          ...
					          <tr>
					            <td><b>Pie:</b></td>
					            <td>15,00%</td>
					            <td><?=str_replace(".","",$vivienda['precio']) * 0.15;?></td>
					            <td id="pago_pie"><?=number_format((str_replace(".","",$vivienda['precio']) * $valor_uf) * 0.15, 0, ',', '.');?></td>
					          </tr>
					
					          <tr style="color:#97272d;">
					            <td><b>Cr&eacute;dito hipotecario:</b></td>
					            <td>85,00%</td>
					            <td><?=str_replace(".","",$vivienda['precio']) * 0.85;?></td>
                    ...
                    <div id="profit_calculated" class="rangeslider-content">
                        <div class="rangeslider-text">
                            ...
                            <p>Dividendo calculado a
                                ...
                                <br>
                                <p>Con un pie del <span id="profitPiePorcentaje">15</span>% equivalente a :<span id="profiPie"><strong>$<?=number_format((str_replace(".","",$vivienda['precio']) * $valor_uf) * 0.15,0,',', '.');?></strong></span></p>
                        </div>
                    </div>
                </div>
                </div>
...
var UF = <?php echo $valor_uf; ?>;
  ...
  var valor_modelo = monto*<?php echo $valor_uf; ?>;
                    var pie_porcentaje = $("input[name='profit_porc']").val();
                    var pie_a = ((monto*pie_porcentaje)/100);
                    var pie = Math.round(pie_a*<?php echo $valor_uf; ?>);
