<?php
 ...
 // Proyectos
    $tag['coloresbaron']  = "Colores Baron";
        ...
        <table id="tabla" style="width:100%;" border="1"> 
            <thead>
                <tr class="cabece">
                    ...
                    <th colspan="2"><b>Modelo</b></th>
                    <th colspan="2"><b>Proyecto</b></th>
                </tr>
            </thead>
            ...
            ?>
                <tr fila="<?php echo $row["id"] ;?>"> 
                    ...
                    <td colspan="2"><?php echo d($row["depto"]); ?></td>
                    <td colspan="2"><?php echo d($row["proyecto"]); ?></td>
                </tr>
            <? 
                }
            ?> 
