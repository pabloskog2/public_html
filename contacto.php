...
<!-- End Google Tag Manager -->
	...
	<title>Colores de Barón - Contacto</title>
...
<style>
        .chang {
          background: url('img/estilo-de-vida-2.jpg');
        }
    @media(max-width:768px){
        .chang {
          background: url('img/estilo-de-vida-2_mobile.jpg');
          padding: 18vh 0;
        }
    }
</style>
<!--<script type="text/javascript" src="https://api.clientify.net/web-marketing/chatbots/script/48284.js"></script>-->
	...
	<section class="jumbotron chang" style="background: url('img/estilo-de-vida-2.jpg') !important; background-size: cover !important;
